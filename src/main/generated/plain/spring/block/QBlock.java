...
public class QBlock extends EntityPathBase<Block> {
    ...
    private static final long serialVersionUID = 1807709199L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBlock block = new QBlock("block");

    public final plain.spring.user.domain.QUser blocked;

    public final plain.spring.user.domain.QUser blocker;
    ...
    public QBlock(Class<? extends Block> type, PathMetadata metadata, PathInits inits) {
        ...
        this.blocked = inits.isInitialized("blocked") ? new plain.spring.user.domain.QUser(forProperty("blocked"), inits.get("blocked")) : null;
        this.blocker = inits.isInitialized("blocker") ? new plain.spring.user.domain.QUser(forProperty("blocker"), inits.get("blocker")) : null;
    }
